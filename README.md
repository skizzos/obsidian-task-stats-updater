...
Markdown- [x] Completed task- [/] Task in progress- [ ] Todo taskMostra più linee
It also detects due dates using the calendar emoji:
Markdown- [ ] Task with deadline 📅 2024-12-31Mostra più linee
...
YAMLtasks_done: 3tasks_doing: 1tasks_todo: 5tasks_total: 9tasks_progress: 33tasks_late: 2tasks_late_percent: 22tasks_status: 🟡 In progressMostra più linee
Status values
